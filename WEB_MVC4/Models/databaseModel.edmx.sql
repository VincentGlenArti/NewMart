...
-- --------------------------------------------------
-- Date Created: 06/14/2015 18:08:07
...
-- Creating primary key on [UserUserId], [ProductID] in table 'CartSet'
ALTER TABLE [dbo].[CartSet]
ADD CONSTRAINT [PK_CartSet]
    PRIMARY KEY CLUSTERED ([UserUserId], [ProductID] ASC);
GO
...
-- Creating foreign key on [UserUserId] in table 'CartSet'
ALTER TABLE [dbo].[CartSet]
